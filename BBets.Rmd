...
We know that 35 students is the incorrect number of students for 
...
Based on the histogram, the number of students in the class for a 2:1 bet would be between 28 to 29 students. 
...
The chart shows that in order for this to be a fair bet with 35 students, the payout must be $4.50. 
